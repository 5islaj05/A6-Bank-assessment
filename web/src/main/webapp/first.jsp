                ...
                <div class="card shadow-lg">
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            <a class="close" data-dismiss="alert" href="./first.jsp">×</a>
                            <h2> £<%= reply.getAmount()%> was successfully transferred! (click transaction info for more) </h2>
<!--                                FROM <%= reply.getFromCardNo()%> TO <%= reply.getToCardNo()%> (CAN BE USED TO SHOW AMOUNT. Blurred out due to wanting to use transaction info button) -->
                            ...
                            <div id="popup1" class="overlay1">
                                <div class="popup1">
                                    ...
                                    <div class="content">
                                        Money transferred from <%= reply.getFromCardNo()%> to <%= reply.getToCardNo()%> <br>
                                        <details>
                        ...
                        <div class="alert alert-danger" role="alert">
                            <a class="close" data-dismiss="alert" href="/first.jsp">×</a>No transaction was made <br>
                        ...
                        <div  class="alert alert-success" role="alert">
                            <a class="close" data-dismiss="alert" href="./first.jsp">×</a>Refund Done 
                        </div>
            ...
            <script src="assets/scripts/first.js"></script>
